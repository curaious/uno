...
export const ChatPage: React.FC = () => {
  ...
  const onUserMessage = (userMessages: MessageUnion[]) => {
    ...
    try {
      ...
      console.warn('Invalid context JSON');
    }
    try {
    ...
    <PageContainer>
      <Box display="flex" flex={1}>
        <div className={styles.sidebar}>
          <div className={classnames(styles.newChatBtn, styles.sidebarMenuItem)} onClick={startNewChat}>
          ...
          <div className={styles.conversationList}>
            <div className={styles.subHeading}>Chats</div>
            {conversations.map(c => (
              <div
                key={c.conversation_id}
                className={classnames(styles.sidebarMenuItem, { [styles.activeSidebarMenuItem]: currentConversationId === c.conversation_id })}
        ...
        <div className={styles.mainContent}>
          <div className={styles.chatContainer}>
            <Chat 
              ...
              contextWindow={currentThread?.meta?.usage as Usage}
            ...
            >
              <Box display="flex" gap="4px" alignItems="center">
                ...
                <SlideDialog
                  ...
                  onClose={() => setAddContextDialogOpen(false)}
                  title="Add Context"
                  width="600px"
                >
                  ...
                  <div style={{ padding: '16px 0', marginTop: 30 }}>
                    <Editor
                      width="100%"
                      height="200px"
                      defaultLanguage="json"
