...
- [Node.js 14+](https://nodejs.org/) (for the quickstart command).
- [Go 1.25.3+](https://go.dev/doc/install) (if you want to use the SDK).
...
- **Uno App** - Backend API (port 6060) and Frontend UI (port 3000)
