...
genai.configure(
    api_key="sk-amg-your-virtual-key-here",  # or your Gemini API key
    client_options={
...
const genAI = new GoogleGenerativeAI('sk-amg-your-virtual-key-here'); // or your Gemini API key
...
func main() {
    ...
    client, err := genai.NewClient(ctx, 
        option.WithAPIKey("sk-amg-your-virtual-key-here"), // or your Gemini API key
...
const genAI = new GoogleGenerativeAI('sk-amg-your-virtual-key-here');
...
func main() {
    ...
    client, err := genai.NewClient(ctx,
        option.WithAPIKey("sk-amg-your-virtual-key-here"),
        option.WithEndpoint("http://localhost:6060/api/gateway/gemini/v1beta"),
    )
    if err != nil {
        panic(err)
