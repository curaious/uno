...
const anthropic = new Anthropic({
  ...
  apiKey: 'sk-amg-your-virtual-key-here', // or your Anthropic API key
});
...
func main() {
    ...
    req.Header.Set("x-api-key", "sk-amg-your-virtual-key-here") // or your Anthropic API key
...
func main() {
    ...
    req, _ := http.NewRequestWithContext(context.Background(), "POST", url, bytes.NewBuffer(jsonData))
    req.Header.Set("Content-Type", "application/json")
    req.Header.Set("x-api-key", "sk-amg-your-virtual-key-here")
